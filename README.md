...
- **Living biomes** — every tier is its own animated world, not a colour swap: parallax layers with large structures anchored in the sky, an atmospheric colour wash, drifting mid-ground sprites, and stage-specific weather. Climb past **lit city towers** with scrolling windows + roof beacons (Rooftops), giant **forest trunks, branches and a green canopy** with falling leaves (Treetops), **fluffy cloud banks + sun shafts** (Cloud Nine), racing **wind streaks and a jet trailing a contrail** (Jet Stream), rising **weather balloons + a signalling dish** (Stratosphere), bold **aurora curtains, ice crystals and snow** (Aurora), **spiral galaxies, asteroids and meteor streaks** in deep space (Space), a huge **Earth limb with orbiting satellites** (Orbit), and a **radiant golden gate, giant twinkling stars and a ringed planet** at the summit (The Stars). The tower and falling block always stay readable, and it all respects reduced-motion. Campaign levels start pre-stacked in their own biome.
